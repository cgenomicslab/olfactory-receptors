"""Download COCONUT (08-2026) and the NCBI taxonomy dump into data/.

    python c00_download_inputs.py                  # both
    python c00_download_inputs.py --only coconut   # or --only taxonomy

Files already present are skipped. Archives are deleted after extraction unless
