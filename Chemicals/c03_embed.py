"""Embed every molecule in the universe with MoLFormer (768 dimensions). Needs a GPU.

Model: ibm-research/MoLFormer-XL-both-10pct at a pinned revision. SMILES longer than 202
tokens are dropped.

Outputs: results/embeddings.npy, results/embed_index.csv
"""
...
def main():
    if not torch.cuda.is_available():
        raise SystemExit(
            ...
            "  every other step is CPU-only and can run anywhere."
        )
